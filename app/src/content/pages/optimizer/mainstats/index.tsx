...
export function PageMainstatsOptimizer() {
  return <div className="page-mainstats-optimizer p-1 grid xl:grid-cols-7">
    <div></div>
    <div className="col-span-5">
      <ToolGrid
        title={GetString("OPTIMIZER.MAINSTAT")}
        side={
        ...
        description={
          <Markdown components={{ li: e => <li {...e} className="mx-6 my-1 list-disc" /> }}>
            {GetString("OPTIMIZER.MAINSTAT", { description: true })}
          </Markdown>
        } />
    </div>
    <div></div>
