...
export function PageArtifactsOptimizer() {
  return <div className="page-substats-optimizer p-1 grid xl:grid-cols-7">
    <div></div>
    <div className="col-span-5">
      <ToolGridVertical
        title={GetString("OPTIMIZER.ARTIFACTS")}
        side={
        ...
        description={
          <Markdown components={{ li: e => <li {...e} className="mx-6 my-1 list-disc" /> }}>
            {GetString("OPTIMIZER.ARTIFACTS", { description: true })}
          </Markdown>
        } />
    </div>
    <div></div>
